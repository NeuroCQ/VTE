#===============================================================
# 7shap.R
# SHAP analysis for the final TOP10 RDF model using training data
#===============================================================
...
df$VTE <- factor(df$VTE, levels = c("No", "Yes"))
...
feature_labels <- c(
  ...
  pre_hb_g_l = "Preop hemoglobin",
  diabetes_history = "Diabetes history",
  sex = "Sex",
  hypertension_history = "Hypertension history",
  pre_aptt_s = "Preop APTT",
  pre_d_dimer_mg_l = "Preop D-dimer",
  pre_rbc_10e12_l = "Preop RBC",
  pre_fdp_ug_ml = "Preop FDP",
  pre_albumin_g_l = "Preop albumin",
  pre_na_mmol_l = "Preop sodium",
  pre_uric_acid_umol_l = "Preop uric acid"
)
